...
// comments
// */
// console.log("Text"); // literal - fixed value
// console.log(a); // variable - variable value
...
// if(true){
//     let variable_test = "Decleared with let inside"
...
// if(true){
//     var variable_test = "Decleared with let inside"
//     console.log(variable_test)
// }
...
// //alert(variable) //variable inside the scope will not be available outside of the scope

// let myText = "First line\nsecond" // multi-line strings, separate with \n
// console.log(myText)
